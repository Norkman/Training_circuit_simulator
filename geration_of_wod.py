...
def simulate_structure(parameters, part, time_of_wod):
    ...
    if wod == "AMRAP":
        ...
        while True :
            ...
            number_of_exercises_per_block_random = int(random.choice(parameters.AMRAP_num_ex_per_block))
            number_of_exercises_random = number_of_exercises_per_block_random*number_of_block_random
            if number_of_exercises_random + parameters.AMRAP_rest <= parameters.AMRAP_num_max_ex and number_of_exercises_random + parameters.AMRAP_delta <= int(time_of_wod) and number_of_exercises_per_block_random + parameters.AMRAP_rest <= int(time_of_wod):
        ...
        while True :
            ...
            for i in range(number_of_block) :
                for y in range(number_of_exercises_per_block) :
                    add_case_part_of_body = random.choice(part)
