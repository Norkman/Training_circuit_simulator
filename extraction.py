...
class DataParameters():
    def __init__(self):
        ...
        self.full_body = extract_parameter("Full_Body", parameters)
        self.upper_body = extract_parameter("Upper_Body", parameters)
        self.lower_body = extract_parameter("Lower_Body", parameters)
        self.emom_num_ex = extract_parameter("EMOM_num_ex", parameters)
        self.emom_num_cycle = extract_parameter("EMOM_num_cycle", parameters)
        self.delta = extract_parameter("EMOM_delta", parameters)
